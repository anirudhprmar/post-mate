...
export default function XPreview({
  ...
  return (
    <div className="w-full max-w-xl rounded-2xl border border-[#eff3f4] dark:border-[#2f3336] bg-white dark:bg-[#000000] p-4 text-left font-sans text-[#0f1419] dark:text-[#e7e9ea] shadow-xl">
      {/* Header Row */}
      <div className="flex items-start justify-between">
        <div className="flex gap-3">
          {avatarUrl ? (
            ...
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#eff3f4] dark:bg-[#16181c] text-[#536471] dark:text-[#71767b]">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-1.5 leading-tight">
              <span className="font-bold text-[#0f1419] dark:text-white text-[15px] hover:underline cursor-pointer">
                {username}
              </span>
              {/* Verified Blue Badge */}
              <svg
                ...
                className="h-[18px] w-[18px] fill-[#1d9bf0] shrink-0"
              >
            ...
            <span className="text-[#536471] dark:text-[#71767b] text-[15px] leading-tight">
              {handle}
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          {/* More Actions menu */}
          <button className="rounded-full p-2 text-[#536471] dark:text-[#71767b] hover:bg-[#f7f7f9] dark:hover:bg-[#16181c] hover:text-[#1d9bf0] transition-colors">
            <svg viewBox="0 0 24 24" className="w-[19px] h-[19px] fill-current">
      ...
      <div className="mt-3">
        {formattedContent ? (
          ...
          <p className="text-[#536471] dark:text-[#71767b] italic text-[15px]">
      ...
      {media.length > 0 && (
        <div
          className={`mt-3 overflow-hidden rounded-2xl border border-[#eff3f4] dark:border-[#2f3336] grid gap-[2px] max-h-[380px] ${
            media.length === 1
              ? "grid-cols-1"
              : media.length === 2
                ? "grid-cols-2"
      ...
      {/* Date/Time Row */}
      <div className="mt-3.5 pb-3.5 text-[#536471] dark:text-[#71767b] text-[15px] font-normal leading-normal">
        <span>{timestamp}</span>
      </div>

      {/* Footer Icons Row */}
      <div className="flex justify-between border-t border-[#eff3f4] dark:border-[#2f3336] pt-3 text-[#536471] dark:text-[#71767b] px-0.5">
        {/* Reply/Comment */}
        <button className="group flex items-center hover:text-[#1d9bf0] transition-colors">
          <div className="rounded-full p-2 group-hover:bg-[#1d9bf0]/10 transition-colors">
            <svg
              viewBox="0 0 24 24"
              className="w-[18px] h-[18px] fill-none stroke-current stroke-[2.25]"
            >
        ...
        {/* Like */}
        <button className="group flex items-center hover:text-[#f91880] transition-colors">
