                      ...
                      {m.type === "image" ? (
                        ...
                        <div className="relative flex h-full w-full items-center justify-center">
                          <video
                            ...
                            className="h-full w-full object-cover"
                          />
                          <button className="absolute bottom-1 left-1 rounded-md bg-black/50 p-1 text-sm text-white opacity-0 transition-opacity group-hover:opacity-100 hover:bg-black/80">
                            add thumbnail
                          </button>
                        </div>
                      )}
