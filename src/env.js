...
export const env = createEnv({
  ...
  server: {
    ...
    THREADS_CLIENT_ID: z.string(),
    THREADS_CLIENT_SECRET: z.string(),
    FB_CLIENT_ID: z.string(),
    FB_CLIENT_SECRET: z.string(),
    // BLUESKY_CLIENT_ID: z.string(),
    // BLUESKY_CLIENT_SECRET: z.string(),
  ...
  runtimeEnv: {
    ...
    // BLUESKY_CLIENT_SECRET: process.env.BLUESKY_CLIENT_SECRET,
