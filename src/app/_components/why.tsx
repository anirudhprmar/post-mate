    ...
    return (
        <section className='mt-10 min-h-screen'>
            <div className='flex flex-col gap-4 items-center '>
                ...
                <p className='text-lg max-w-sm text-muted-foreground text-center'>This is where post mate comes in to bridge the gap from content creation to scheduling.</p>
            </div>
