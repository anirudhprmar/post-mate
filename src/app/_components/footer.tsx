...
const socialLinks = [
    ...
    },
    {
        ...
        href: 'https://instagram.com/postmate',
        label: 'Instagram'
    },
]
                ...
                <div className="flex flex-col gap-10 lg:flex-row lg:justify-between">
                    ...
                    <div className="flex flex-col gap-5 max-w-xs">
                        ...
                        <p className="text-muted-foreground text-sm leading-relaxed">
                            post mate makes content creation simple for different social media platforms, capturing the essence of each platform & help post content to multiple platforms at the same time. all in one place.
                        </p>
